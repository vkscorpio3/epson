 ...
 *
 */
package hybris.epson.cockpits.setup;
...
import hybris.epson.cockpits.constants.EpsonCockpitsConstants;
 ...
 */
@SystemSetup(extension = EpsonCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(EpsonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(EpsonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						EpsonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/epsoncockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
