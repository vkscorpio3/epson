 ...
 *
 */
package hybris.epson.test.setup;
...
import hybris.epson.test.constants.EpsonTestConstants;
import hybris.epson.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EpsonTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/epsontest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/epsontest/import/reviews.impex");
			...
			importImpexFile(context, "/epsontest/import/cstickets.impex");
		}
	}
}
