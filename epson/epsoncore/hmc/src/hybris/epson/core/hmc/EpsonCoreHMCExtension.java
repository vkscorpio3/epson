...
/**
 * Provides necessary meta information about the epsoncore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class EpsonCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(EpsonCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "hybris.epson.core.hmc.locales";
