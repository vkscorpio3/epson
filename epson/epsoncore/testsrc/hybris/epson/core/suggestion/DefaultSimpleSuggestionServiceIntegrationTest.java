 ...
 *
 */
package hybris.epson.core.suggestion;
...
import hybris.epson.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/epsoncore/test/testSimpleSuggestionService.csv", "utf-8");
	}
