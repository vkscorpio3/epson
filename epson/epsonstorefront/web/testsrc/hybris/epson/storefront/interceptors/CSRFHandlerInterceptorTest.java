 ...
 *
 */
package hybris.epson.storefront.interceptors;
...
import hybris.epson.storefront.util.CSRFHandlerInterceptor;
import hybris.epson.storefront.util.CSRFTokenManager;
...
{
	private final String SESSION_CSRF_ATTRIBUTE = "hybris.epson.storefront.util.CSRFTokenManager.tokenval";
